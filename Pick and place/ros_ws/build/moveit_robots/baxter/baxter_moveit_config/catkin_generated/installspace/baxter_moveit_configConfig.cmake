...
if("FALSE" STREQUAL "TRUE")
  set(baxter_moveit_config_SOURCE_PREFIX /home/lilinxing/ros_ws/src/moveit_robots/baxter/baxter_moveit_config)
  set(baxter_moveit_config_DEVEL_PREFIX /home/lilinxing/ros_ws/devel)
  ...
  set(baxter_moveit_config_INSTALL_PREFIX /home/lilinxing/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lilinxing/ros_ws/install/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
