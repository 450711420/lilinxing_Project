...
if("TRUE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/lilinxing/ros_ws/src/image_transport_ws/image_common/camera_calibration_parsers)
  set(camera_calibration_parsers_DEVEL_PREFIX /home/lilinxing/ros_ws/devel)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /home/lilinxing/ros_ws/install)
...
if(NOT "/home/lilinxing/ros_ws/src/image_transport_ws/image_common/camera_calibration_parsers/include " STREQUAL " ")
  set(camera_calibration_parsers_INCLUDE_DIRS "")
  set(_include_dirs "/home/lilinxing/ros_ws/src/image_transport_ws/image_common/camera_calibration_parsers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lilinxing/ros_ws/src/image_transport_ws/image_common/camera_calibration_parsers/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lilinxing/ros_ws/devel/lib;/opt/ros/indigo/lib)
